...
See the [search syntax reference and design review](docs/SEARCH_SYNTAX.md) for operators, examples, current limitations, and decisions for a future mobile app.
